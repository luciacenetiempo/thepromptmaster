    ...
    <>
      ...
      <div className='section-content fullheight'>
        <div className='content rich-text-block rich-text-block--newsletter'>
          ...
          <h2 className='tx-center'>ChatGPT, GPT Custom, Assitants, Agents...<br/>DA TOOL A TASK FORCE</h2>
          <NewsletterFormSlide 
            ...
            success=''
            error=''
            speechName='AIWEEK - Assistants'
            slideLink='/file/aiweek/20250514-aiweek-4.pdf'
          />
        </div>
      </div>
      <div className=''>
