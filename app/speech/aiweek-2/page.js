    ...
    <>
      ...
      <div className='section-content fullheight'>
        <div className='content rich-text-block rich-text-block--newsletter'>
          ...
          <h2 className='tx-center'>Prompt Design avanzato per chi ha già iniziato MA VUOLE FARE SUL SERIO</h2>
          <NewsletterFormSlide 
            ...
            success=''
            error=''
            speechName='AIWEEK - ChatGPT 2'
            slideLink='/file/aiweek/20250513-aiweek-2.pdf'
          />
        </div>
      </div>
      <div className=''>
