...
export const metadata = {  
  title: "Wired Next Fest - The Prompt Master",
    ...
    <>
      ...
      <div className='section-content fullheight'>
        <div className='content rich-text-block rich-text-block--newsletter'>
          ...
          <h2 className='tx-center'>Generative AI<br/>
          Superpower Experience</h2>
          <NewsletterFormSlide 
            ...
            success=''
            error=''
            speechName='Wired Next Fest'
            slideLink='/file/wirednextfest/20251004-wirednextfest.pdf'
          />
        </div>
      </div>
      <div className=''>
